...
<meta name="copyright" content="违法和不良信息举报99999999@qq.com 经营许可证：浙A2-20110026 浙ICP备11017770号 copyright@ 2016-2017 浙江A&F信息工程学院版权所有" />
<title>后台管理主页</title>
...
<div id="loading" style="position:absolute;z-index:1000;top:0px;left:0px;width:100%;height:100%;background:#FFFFFF;text-align :center;padding-top:6%;">
	...
	<div class="wu-footer" data-options="region:'south',border:true,split:true">
    	&copy; 违法和不良信息举报99999999@qq.com 经营许可证：浙A2-20110026 浙ICP备11017770号 copyright@ 2016-2017 浙江A&F信息工程学院版权所有
    </div>
    <!-- end of footer -->  
