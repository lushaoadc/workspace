...
<body>
	...
	<div class="shop_hd">
		...
		<div class="shop_hd_topNav">
			<div class="shop_hd_topNav_all">
				...
				<div class="shop_hd_topNav_all_left">
					<p>您好，欢迎来到<b><a href="/OnlineShop">胖胖杂货店</a></b>
		...
		<div class="shop_hd_header">
			<div class="shop_hd_header_logo"><a href="/OnlineShop"><img src="../resources/home/images/logo.png" height="110%" alt="ShopCZ" /></a></div>
			    ...
			    <div class="search_form">
			    	<form method="post" action="../product/search">
			    		<div class="search_formstyle">
			    			<input type="text" class="search_form_text" name="search_content" placeholder="快来搜索您想要的商品吧！" value="${search_content }" />
