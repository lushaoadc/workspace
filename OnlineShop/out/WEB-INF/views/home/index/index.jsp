                      ...
                      <div id="xifan_bd1lfimg" style="width:780px;height:350px;">
                        <div >
                          <dl class="" style="width:780px;height:350px;">
                            <dt><a href="" title="" target="_blank"><img width="780px" height="360px" src="../resources/home/images/duanwu.jpg"></a></dt>
                            <dd><h2><a href="" target="_blank">端午节大促销</a></h2></dd>
                          </dl>
                          <dl class="" style="width:780px;height:350px;">
                            <dt><a href="" title="" target="_blank"><img width="780px" height="360px" src="../resources/home/images/duanwu.jpg"></a></dt>
                            <dd><h2><a href="" target="_blank">端午节促销活动</a></h2></dd>
                          </dl>
                          <dl class="" style="width:780px;height:350px;">
                            <dt><a href="" title="" target="_blank"><img width="780px" height="360px" src="../resources/home/images/xiaji.jpg"></a></dt>
                            <dd><h2><a href="" target="_blank">夏季大促销</a></h2></dd>
                          </dl>
                          <dl class="" style="width:780px;height:350px;">
                            <dt><a href="" title="" target="_blank"><img width="780px" height="360px" src="../resources/home/images/biye.jpg" ></a></dt>
                            <dd><h2><a href="" target="_blank">毕业季促销打折季</a></h2></dd>
                          </dl>
                        </div>
                      </div>
                    </div>
